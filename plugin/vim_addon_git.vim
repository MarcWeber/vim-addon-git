fun! EnableGitCommands()

  " I chose to let all command!s end by Git intentionally
...
if isdirectory('.git')
  call EnableGitCommands()
endif

command! -nargs=0 EnableGitCommands call EnableGitCommands()
